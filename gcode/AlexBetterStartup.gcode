; Changed made:
; - Continue with gcode, while preheating bed
; - Turn on ALL fans when waiting for nozzle cooldown
; - Extra wipe after reheating
; - Fast re-homing
; - Supports 0.4 and 0.6 nozzles. (Different wipes)
; - Fast back to wipe position
...
T1000
    ...
    ;===== Custom: Move back to wipe for last wipe before print =============
    G1 X60 Y245 F12000
    G1 Y265 F3000
...
G0 Z2.5 F500
G0 Z5 E0.25 F50
G0 Z0.2 X25 E0.25 F{outer_wall_volumetric_speed/(0.3*0.5)/ 4     * 60}
G0 E-0.2
G0 X40
